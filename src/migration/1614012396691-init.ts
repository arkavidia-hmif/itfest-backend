...
export class init1614012396691 implements MigrationInterface {
    name = 'init1614012396691'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "user_role_enum" AS ENUM('admin', 'tenant', 'visitor')`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "email" character varying, "username" character varying NOT NULL, "name" character varying NOT NULL DEFAULT 'anonymous', "role" "user_role_enum" NOT NULL DEFAULT 'visitor', "salt" character varying, "password" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isVerified" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tenant" ("point" integer NOT NULL, "isLive" boolean NOT NULL DEFAULT false, "liveURL" character varying NOT NULL DEFAULT '-', "userId" integer NOT NULL, CONSTRAINT "REL_a6719c3ba1ea75a8f255e3e5c7" UNIQUE ("userId"), CONSTRAINT "CHK_e0d89066b4d90a2467a0a681c2" CHECK ((point >= 0)), CONSTRAINT "PK_a6719c3ba1ea75a8f255e3e5c7d" PRIMARY KEY ("userId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "checkout_item" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "checkoutId" integer NOT NULL, "itemId" integer NOT NULL, CONSTRAINT "CHK_ffd6094982eec660bd1ab19cf9" CHECK ((quantity >= 0)), CONSTRAINT "PK_bdc9820fb60a42a3bb955d8508f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "global_scoreboard" ("id" SERIAL NOT NULL, "score" integer NOT NULL DEFAULT 0, "lastUpdated" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, CONSTRAINT "PK_fe86990d52851358653f5b74d37" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "scoreboard" ("id" SERIAL NOT NULL, "score" integer NOT NULL DEFAULT 0, "playedAt" TIMESTAMP NOT NULL DEFAULT now(), "gameId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_ee9f6e819e7a4a11d569b54c060" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "verification" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "type" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_f7e3a90ca384e71d6e2e93bb340" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "checkout_item" ADD CONSTRAINT "FK_22ada8badf52f03967d9988406f" FOREIGN KEY ("checkoutId") REFERENCES "checkout"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "global_scoreboard" ADD CONSTRAINT "FK_403799da51e60ca189beab7fa79" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "global_scoreboard" DROP CONSTRAINT "FK_403799da51e60ca189beab7fa79"`);
        ...
        await queryRunner.query(`ALTER TABLE "checkout_item" DROP CONSTRAINT "FK_22ada8badf52f03967d9988406f"`);
