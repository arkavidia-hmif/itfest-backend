...
export class init1611420654784 implements MigrationInterface {
    name = 'init1611420654784'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "visitor" ("dob" TIMESTAMP, "gender" integer, "interest" text, "point" integer NOT NULL DEFAULT 0, "filled" boolean NOT NULL DEFAULT false, "userId" integer NOT NULL, CONSTRAINT "REL_57938638c006099d5fb86c1b1e" UNIQUE ("userId"), CONSTRAINT "CHK_b44c4cdb8d424f9708d087999f" CHECK ((point >= 0)), CONSTRAINT "PK_57938638c006099d5fb86c1b1ec" PRIMARY KEY ("userId"))`, undefined);
        await queryRunner.query(`CREATE TABLE "tenant" ("point" integer NOT NULL, "x" integer NOT NULL, "y" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "REL_a6719c3ba1ea75a8f255e3e5c7" UNIQUE ("userId"), CONSTRAINT "CHK_e0d89066b4d90a2467a0a681c2" CHECK ((point >= 0)), CONSTRAINT "PK_a6719c3ba1ea75a8f255e3e5c7d" PRIMARY KEY ("userId"))`, undefined);
